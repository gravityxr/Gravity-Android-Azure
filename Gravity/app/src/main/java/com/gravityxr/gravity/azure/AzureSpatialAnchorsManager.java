...
public class AzureSpatialAnchorsManager {
    ...
    public static final String SpatialAnchorsAccountId = "5db0f1a5-feaa-47d0-b4ff-4557ee553608";

    // Set this string to the account key provided for the Azure Spatial Service resource.
    public static final String SpatialAnchorsAccountKey = "YQwYzbafF7aMBE2om6ESc54QrA60MEVaIaTYCW9IIGI=";
